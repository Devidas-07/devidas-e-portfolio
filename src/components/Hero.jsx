    ...
    <section id="about" className="py-5">
      <div className="row align-items-center">
        <div className="col-md-6 text-center text-md-start">
          ...
          <p className="lead">I am an IT Analyst currently working at Cognizant. I specialize in building scalable, data-oriented solutions using Java, cloud services and analytics tools. I focus on reliable integrations, data pipelines and clear visualizations to help teams make better decisions.</p>
          <div className="mt-4">
